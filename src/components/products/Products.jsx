                ...
                <div className="navBarPadding containerDiv bg-white">
                    <div className="flex items-center font-[500] justify-between">
                        ...
                        {/* <div className="flex justify-center gap-3 text-[16px]">
                            ...
                            <button
                                className={`btn btn-primary bg-[#0059BC] leading-[18.75px] text-[#FFFFFF] rounded-[4px] py-1 px-2 ${showFavorites &&
                                    ...
                                    <Link to="https://nttdata-solutions.com/tr/">
                                        <div className="">
                                            <img
                                                src={item.image}
                                                alt={item.name}
                                                className="w-full max-h-[279px]"
                                            />
                                        </div>
                                    </Link>

                                    <div className="flex flex-col justify-around min-h-[172px]">
                                        <h2 className="px-1 w-full font-bold">{item.title}</h2>
                                        ...
                                        {/* <div className="relative">
                                            {" "}
                                            <p
                                                className={` px-1 font-[400] text-[12px]  ${!showMoreLine[item.id] ? "clapText" : ""
                                                    }  `}
                                            >
                                                {item.description}
                                            </p>
